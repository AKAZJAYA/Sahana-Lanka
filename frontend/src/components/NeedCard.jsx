...
const NeedCard = ({ need }) => {
  ...
  return (
    <div className="group bg-white rounded-2xl shadow-sm hover:shadow-xl border border-gray-100 p-6 mb-4 transition-all duration-300 hover:-translate-y-1">
      {/* Header */}
      ...
      <div className="space-y-3 pt-4 border-t border-gray-100">
        ...
        {need.location && (
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              <p className="text-gray-700 text-sm font-medium mb-2">{need.location}</p>
              {need.lat && need.lng && (
                <button
                  onClick={openInMaps}
